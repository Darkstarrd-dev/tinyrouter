...
func TestRecordUsage(t *testing.T) {
	...
	h.recordUsage("test-id", "test", "gpt-4", sel, "success", 100, 50, 10, 20, "", nil, nil, nil, 0)
...
func TestRecordUsage_DebugModeCapture(t *testing.T) {
	...
	h.recordUsage("test-id", "test", "gpt-4", sel, "success", 100, 50, 10, 20, "", []byte(`{"req":true}`), []byte(`{"resp":true}`), headers, 200)
}
