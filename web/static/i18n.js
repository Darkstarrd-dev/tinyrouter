...
resetQuota: '重置配额', confirmResetQuota: '清空所有冷却计时器和配额锁定？这将使所有密钥立即可用。', quotaReset: '所有冷却和配额锁定已清除。',
    ...
    // Gallery keys
    galleryOpen: 'Open',
    galleryDropHint: 'Drop a folder / image / zip here, paste, or click to open',
    galleryAutoplay: 'Autoplay',
    galleryPause: 'Pause',
    ...
    galleryInterval: 'Interval',
    galleryLoading: 'Loading...',
    galleryEmpty: 'No images loaded. Drop a folder, a single image, multiple images, or a .zip archive.',
    galleryZipTooLarge: 'ZIP too large (max 500MB).',
    galleryZipBroken: 'ZIP could not be read.',
    galleryTiffConvertFail: 'TIFF conversion failed.',
    galleryFetchFail: 'Failed to load image.',
    // Playground keys moved to pg-i18n.js
    // Shortcut Settings keys
