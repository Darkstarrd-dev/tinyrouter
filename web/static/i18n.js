...
const L = {
  en: {
    ...
    loading: 'Loading', untested: 'Untested', available: 'Available', exhausted: 'Exhausted',
    cooldown: 'Cooldown', dailyLocked: 'Daily Locked', unlockAt: 'Unlock at', noKeys: 'No keys configured.',
  ...
  cn: {
    ...
    loading: '加载中', untested: '未测试', available: '可用', exhausted: '已耗尽',
    cooldown: '冷却中', dailyLocked: '日配额锁定', unlockAt: '解锁时间', noKeys: '无配置密钥。',
