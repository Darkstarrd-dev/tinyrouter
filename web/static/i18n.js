...
resetQuota: '重置配额', confirmResetQuota: '清空所有冷却计时器和配额锁定？这将使所有密钥立即可用。', quotaReset: '所有冷却和配额锁定已清除。',
    ...
    // Gallery keys
    galleryOpen: '打开',
    galleryDropHint: '拖入目录 / 图片 / zip，或粘贴，或点击打开',
    galleryAutoplay: '自动播放',
    galleryPause: '暂停',
    galleryPrev: '上一张',
    galleryNext: '下一张',
    ...
    galleryInterval: '间隔',
    galleryLoading: '加载中...',
    galleryEmpty: '尚未加载图片。可拖入目录、单张图片、多张图片或 .zip 压缩包。',
    galleryZipTooLarge: 'ZIP 过大（上限 500MB）。',
    galleryZipBroken: 'ZIP 读取失败。',
    galleryTiffConvertFail: 'TIFF 转码失败。',
    galleryFetchFail: '获取图片失败。',
    // Playground keys moved to pg-i18n.js
  }
};
